...
function SoundUtil.PlaySfxInBattle(eventPath, bank, gameObject)
  SoundManager:PlaySfxSound(eventPath, bank, gameObject, true)
end

function SoundUtil.PlayUISfx(soundPath, bankName, gameObject)
  if soundPath then
    SoundManager:PlaySfxSound(soundPath, bankName or "bank:/sfx/sfx_ui/ui_sys/ui_sys", gameObject)
  end
end
...
function SoundUtil.PlayMusic(soundPathId, dontSaveAsLastSound)
